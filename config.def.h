...
static Key keys[] = {
   ...
   /* mod  key                          function  argument */
	...
	{ 0,   XF86XK_AudioMute,			spawn,    SHCMD("amixer sset Master toggle_mute; pkill -RTMIN+10 dwmblocks") },
...
static Button buttons[] = {
	...
	{ ClkStatusText,        MODKEY,			Button1,        sigdwmblocks,   {.i = 7} },
	{ ClkStatusText,        MODKEY,			Button2,        sigdwmblocks,   {.i = 8} },
	{ ClkStatusText,        MODKEY,			Button3,        spawn,			SHCMD("$TERMINAL -e nvim ~/repos/suckless/dwmblocks/blocks.def.h") },
